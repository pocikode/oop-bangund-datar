...
class Segitiga extends BangunDatar
{
    ...
    public function submit()
    {
		...
		if (isset($_POST['luas'])) {
			...
			$this->hitungKeliling($sisi, $sisi2, $sisi3, $kaki, $satuan, $jenis);
			return $this->hasil;
		}
    }
    ...
    private function hitungKeliling($sisi, $sisi2, $sisi3, $kaki, $satuan, $jenis)
    {
    	if ($jenis == 'sama-sisi') {
    		$kel = $sisi*3;
    	} elseif ($jenis == 'sama-kaki') {
    		$kel = $sisi + ($kaki*2);
    	} elseif ($jeniss == 'sembarang') {
    		$kel = $sisi+$sisi2+$sisi3;
    	}
